        ...
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <div class="mt-2">
                        <a href="tel:{{ get_setting('contact_phone') }}" class="helpline-btn footer-big-btn">
                            <div class="ic"><i class="la la-phone"></i></div>
                            <p>{{translate('Phone')}}</p>
                            <h5>{{ get_setting('contact_phone') }}</h5>
                        </a>
                        <a href="mailto:{{ get_setting('contact_email') }}" class="helpline-btn footer-big-btn">
                            <div class="ic"><i class="la la-envelope"></i></div>
                            <p>{{translate('Email')}}</p>
                            <h5>{{ get_setting('contact_email')  }}</h5>
                        </a>
                    </div>
                </div>
            </div>
