                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <table class="product-info-table">
                                <tbody><tr class="product-info-group">
                                    <td class="product-info-label">Price</td>
                                    <td class="product-info-data product-price">{{ home_discounted_price($detailedProduct->id) }}</td>
                                </tr>
                                <tr class="product-info-group">
                                    <td class="product-info-label">Regular Price</td>
                                    <td class="product-info-data product-regular-price">
                                        {{home_price($detailedProduct->id)}}</td>
                                </tr>
                                <tr class="product-info-group">
                                ...
                                {{-- <tr class="product-info-group">
                                    <td class="product-info-label">Unit</td>
                                    <td class="product-info-data product-code">{{ $detailedProduct->getTranslation('unit') }}</td>
                                </tr> --}}
                                <tr class="product-info-group" >
                                    <td class="product-info-label">Brand</td>
                                    <td class="product-info-data product-brand" >{{ $detailedProduct->brand->getTranslation('name') }}</td>
                                </tr>
                                </tbody>
                            </table>
...
{{--                                <ul><li>Model: HEBE M3</li>--}}
{{--                                    <li>Premium Virtual 7.1 Surround-Sound</li>--}}
{{--                                    <li>Omnidirectional Microphone</li>--}}
{{--                                    <li>Exclusive RGB Streaming</li>--}}
{{--                                    <li>Exquisite Earcup Facade</li>--}}
{{--                                </ul>--}}
                            </div>
                            ...
                            <form id="option-choice-form">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-2">
                                        <div class="font_size-qty my-2">{{ translate('Quantity')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
...
{{--                            <hr>--}}
                            <div class="d-flex">
                            <div class="p-wrap mr-2" >
                                <span class="price">{{ home_discounted_price($detailedProduct->id) }}</span>
                                <div class="p-tag">Cash Discount Price</div>
                                <div class="p-tag">Online / Cash Payment  </div>
                            </div>
                            <div class="p-wrap ">
                                <span class="price">{{ home_price_emi($detailedProduct->id) }}/Month</span>
                                <div class="p-tag">Regular Price</div>
                                <div class="p-tag">0% EMI for 6 Months</div>
                            </div>
                            </div>
