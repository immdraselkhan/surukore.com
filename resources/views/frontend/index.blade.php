...
{{--                <div class="col-lg-3 position-static d-lg-block">--}}
{{--                    <div class="intro-banners">--}}
{{--                        <div class="el_shop_banner2 mb-2">--}}
{{--                            <a href="#">--}}
{{--                                <img src="{{ url('public/uploads/all/left-banner-2.png') }}" alt="Banner">--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                        <div class="el_shop_banner2">--}}
{{--                            <a href="#">--}}
{{--                                <img src="{{ url('public/uploads/all/left-banner-1.png') }}" alt="Banner">--}}
{{--                            </a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </div>--}}
